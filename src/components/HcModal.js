...
//bootstrap-vue/es/components/modal/modal

import bBtn from 'bootstrap-vue/es/components/button/button';
import bBtnClose from 'bootstrap-vue/es/components/button/button-close';

//import { idMixin, listenOnRootMixin } from 'bootstrap-vue/es/mixins';
import idMixin from 'bootstrap-vue/es/mixins/id';
import listenOnRootMixin from 'bootstrap-vue/es/mixins/listen-on-root';

//import { observeDom, warn, KeyCodes } from 'bootstrap-vue/es/utils';
import observeDom from 'bootstrap-vue/es/utils/observe-dom';
import warn from 'bootstrap-vue/es/utils/warn';
import KeyCodes from 'bootstrap-vue/es/utils/key-codes';

import BvEvent from 'bootstrap-vue/es/utils/bv-event.class';

import { isVisible, selectAll, select, getBCR, addClass, removeClass, hasClass, setAttr, removeAttr, getAttr, hasAttr, eventOn, eventOff } from 'bootstrap-vue/es/utils/dom';
